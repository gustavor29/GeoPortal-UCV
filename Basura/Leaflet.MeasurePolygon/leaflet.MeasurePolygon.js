// Crea una clase para el plugin
    L.Control.MeasurePolygon = L.Control.extend({
        options: {
            position: 'topleft',
            icon_active: './dist/Leaflet.MeasurePolygon/icons8-radar-plot-50.png',
            icon_inactive: './dist/Leaflet.MeasurePolygon/icons8-polygon-80.png',
        ...
        _UpdateAreaPerimetro(layer) {
            ...
            let areaValue = `${(area/1e6).toLocaleString('en-US', options)} Km²`;
